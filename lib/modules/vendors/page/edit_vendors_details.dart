  ...
  Widget build(BuildContext context) {
    return BlocConsumer<VendorDetailsBloc, VendorDetailsState>(
      listener: (context, state) {
        ...
        } else if (state.vendorDetailsStatus ==
            GetVendorsDetailsStatus.updated) {
          CenterLoader.hide();
      ...
      builder: (context, state) {
        return WillPopScope(
          ...
          child: MainLayout(
            ...
            body: (state.vendorDetailsStatus ==
                        GetVendorsDetailsStatus.initial ||
                    state.vendorDetailsStatus ==
                        GetVendorsDetailsStatus.loading)
                ? const CenterLoader()
                : Form(
                    key: _formKey,
