...
class EditNewProductGstDialog extends StatefulWidget {
  final Map<String, dynamic> sparePart;
  final String gstBill;

  const EditNewProductGstDialog({
    super.key,
  ...
  @override
  State<EditNewProductGstDialog> createState() =>
      _EditNewProductGstDialogState();
}

class _EditNewProductGstDialogState extends State<EditNewProductGstDialog> {
  late TextEditingController nameController;
  late TextEditingController rateController;
  late TextEditingController qtyController;
  late TextEditingController hsnController;
  late String unitController = "PCS";
  late String gstController = "None";
  ...
  void initState() {
    ...
    gstController = widget.sparePart['product_gst'].toString();
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  final updatedSparePart = {
                    ...
                    'product_gst':
                        widget.gstBill == "1" ? gstController : "None",
