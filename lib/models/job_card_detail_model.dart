...
class JobSheetDetailModel extends Equatable {
  ...
  final String? batteryImg;
  final String? speedometer;
  final String? fuel;
  ...
  final String? vehicleBatteryThumb;
  final String? vehicleSpeedometerThumb;
  ...
  const JobSheetDetailModel(
      ...
      this.vehicleBatteryThumb,
      this.vehicleSpeedometerThumb,
  ...
  JobSheetDetailModel copyWith({
    ...
    String? vehicleBatteryThumb,
    String? vehicleSpeedometerThumb,
    ...
    JobSheetDetailModel jobSheetDetailsModel = JobSheetDetailModel(
        ...
        batteryImg: batteryImg ?? this.batteryImg,
        ...
        vehicleBatteryThumb: vehicleBatteryThumb ?? this.vehicleBatteryThumb,
        vehicleSpeedometerThumb:
            vehicleSpeedometerThumb ?? this.vehicleSpeedometerThumb,
  ...
  factory JobSheetDetailModel.fromJson(Map<String, dynamic> json) {
    return JobSheetDetailModel(
      ...
      comments: jsonDecode((json['comments'])) ?? [],
      ...
      batteryImg: json['vehicle_battery'] ?? "",
      speedometer: json['vehicle_speedometer '] ?? "",
      fuel: json['fuel'] ?? "",
      ...
      vehicleBatteryThumb: json['battery_thumb'] ?? "",
      vehicleSpeedometerThumb: json['speedometer_thumb'] ?? "",
  ...
  @override
  String toString() =>
      '{id: $id, address: $address, assignMechanics: $assignMechanics,comments:$comments,companyId:$companyId,companyname:$companyname, createdAtDate: $createdAtDate, createdAtTime: $createdAtTime,createdBy:$createdBy, customerComplaints: $customerComplaints, customerId:$customerId,dashboardImg: $dashboardImg, deletedAt: $deletedAt, dickeyImg: $dickeyImg, email: $email, frontImg: $frontImg, fuel: $fuel, frontImg: $frontImg,batteryImg:$batteryImg,speedometer:$speedometer, fuel: $fuel, $fullName: $fullName, image1Img: $image1Img, image1thumb: $image1Thumb, image2Img: $image2Img, image2Thumb: $image2Thumb, image3Img: $image4Img, image3Thumb : $image3Thumb, image3Img: $image4Img, image4Thumb: $image4Thumb, items: $items, jobSheetId: $jobSheetId, kms: $kms, leftImg: $leftImg, manufacturers: $manufacturers,status:$status,mobileNumber: $mobileNumber,alternateMobileNumber:$alternateMobileNumber, rearImg: $rearImg, rightImg: $rightImg, updatedAt: $updatedAt, vahicleDashboardThumb: $vehicleDashboardThumb, vehicleDickeyThumb: $vehicleDickeyThumb, vehicleFrontThumb: $vehicleFrontThumb, vehicleLeftThumb: $vehicleLeftThumb,vehicleBatteryThumb:$vehicleBatteryThumb,vehicleSpeedometerThumb:$vehicleSpeedometerThumb, vehicleName: $vehicleName, vehicleNumber: $vehicleNumber,  vehicleRearThumb: $vehicleRearThumb, vehicleRightThumb: $vehicleRightThumb,gstNumber:$gstNumber,dueDate:$dueDate}';
}
