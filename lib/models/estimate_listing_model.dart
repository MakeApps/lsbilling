...
class EstimateListingModel extends Equatable {
  ...
  @override
  String toString() =>
      '{id: $id, address: $address, createdAtTime: $createdAtTime, deletedAt: $deletedAt, email:$email,estimateNumber:$estimateNumber,estimateTotal:$estimateTotal,flag:$flag,fullname:$fullname ,manufacturers:$manufacturers,mobileNumber:$mobileNumber,temp_date:$tempDate,updateAt:$updateAt,}';
}
